			...
			<div class="sticky">
				<aside class="app-sidebar sidebar-scroll">
					...
					<div class="main-sidemenu">
						<div class="main-sidebar-loggedin">
							<div class="app-sidebar__user">
								<div class="dropdown user-pro-body text-center">
									...
									<div class="user-info">
										<h6 class=" mb-0 text-dark">Saya Adalah</h6>
						...
						<ul class="side-menu ">
							<li class="slide">
								<a class="side-menu__item" href="index.html"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Belajar template</span></a>
							</li>
							<li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide"   href="javascript:void(0);"><i class="side-menu__icon fe fe-box"></i><span class="side-menu__label">Latihan 1</span><i class="angle fe fe-chevron-down"></i></a>
								<ul class="slide-menu">
							...
							<li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide"   href="javascript:void(0);"><i class="side-menu__icon fe fe-award "></i><span class="side-menu__label">Latihan 2</span><i class="angle fe fe-chevron-down"></i></a>
								<ul class="slide-menu">
							...
							<li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide"   href="javascript:void(0);"><i class="side-menu__icon fe fe-layers "></i><span class="side-menu__label">Latihan 3</span><i class="angle fe fe-chevron-down"></i></a>
								<ul class="slide-menu">
							...
							<li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide"   href="javascript:void(0);"><i class="side-menu__icon fe fe-package "></i><span class="side-menu__label">Latihan 4</span><i class="angle fe fe-chevron-down"></i></a>
								<ul class="slide-menu">
							...
							<li class="slide">
								<a class="side-menu__item" data-bs-toggle="slide"   href="javascript:void(0);"><i class="side-menu__icon fe fe-compass"></i><span class="side-menu__label">Latihan 5</span><i class="angle fe fe-chevron-down"></i></a>
								<ul class="slide-menu">
